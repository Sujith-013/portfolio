...
function ContactForm() {
  ...
  return (
    <div>
      <p className="font-display font-medium mb-5 text-accent text-xl uppercase">Contact with me</p>
      <div className="max-w-3xl text-text-primary rounded-lg border border-border-strong p-3 lg:p-5">
        ...
        <div className="mt-6 flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            ...
            <input
              className="bg-surface-raised w-full border rounded-md border-border-strong focus:border-accent ring-0 outline-0 transition-all duration-300 px-3 py-2"
              type="text"
              maxLength="100"
              required={true}
          ...
          <div className="flex flex-col gap-2">
            ...
            />
            {error.email && <p className="text-sm text-danger">Please provide a valid email!</p>}
          </div>
          ...
          <div className="flex flex-col items-center gap-3">
            {error.required && <p className="text-sm text-danger">
