  ...
  return (
    ...
    >
      ...
      <Link
        ...
        className="inline-flex items-center gap-1 rounded-full border border-border-strong px-5 py-2.5 text-xs sm:text-sm font-medium uppercase tracking-wider text-text-primary no-underline hover:text-accent hover:border-accent"
      >
